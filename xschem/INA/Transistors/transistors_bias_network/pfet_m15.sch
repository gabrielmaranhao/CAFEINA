...
C {devices/lab_wire.sym} -140 270 2 0 {name=p8 sig_type=std_logic lab=D}
...
C {devices/lab_wire.sym} -130 220 0 1 {name=p4 sig_type=std_logic lab=B}
C {devices/lab_wire.sym} -200 220 0 1 {name=p5 sig_type=std_logic lab=G}
C {sky130_fd_pr/pfet_01v8_hvt.sym} -160 220 0 0 {name=M3
L=1
W=1
nf=1
mult=5
